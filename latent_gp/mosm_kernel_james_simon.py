...
class MOSM_Kernel(gpytorch.kernels.Kernel):
    ...
    def __init__(self,
        ...
        variance = Parameter( torch.ones(*self.batch_shape, self.output_dims, self.Q, self.input_dims) )
        ...
        ### still not sure how to make unconstrained parameters though...
...
if __name__ == "__main__":
    N, M, b_n, d = 100, 50, 2, 1
    x = torch.rand(b_n,N,d)
    x2 = torch.rand(b_n,M,d)
